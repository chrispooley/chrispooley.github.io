...
function showstatistics()                                 // Shows statistics
{
	...
	if(width < 1000){ x1 = 40; x2 = 145; x3 = 260; x4 = 455; x5 = 530; xslid = 600;}
	else{ x1 = 40; x2 = 160; x3 = 290; x4 = 500; x5 = 620; xslid = 700;}
	...
	if(page == INFERENCEPAGE){	
		...
		if(res.ch[0].nsampread == 1) addbutton("Value",menux+x2,y,50,15,-1,STATBUT2,-1,-1); 
			...
			addbutton("Mean",menux+x2,y,50,15,-1,STATBUT2,-1,-1);            
			addbutton("95% of Simulations",menux+x3,y,50,15,-1,STATBUT2,-1,-1);  
		}
	}
	...
	if(tableyfrac < 1) addbutton("",menux+xslid,120,13,hei,SLIDEAC,YSLIDEBUT,-1,-1);		
