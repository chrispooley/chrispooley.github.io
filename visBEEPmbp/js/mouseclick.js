  ...
  case RELOADAC:
	...
	case STARTAC:
		...
		case SIMULATEPAGE:
			...
			switch(text){
			case "Start": case "Rerun": case "Load": case "Init":
		...
		case INFERENCEPAGE:
			switch(text){
			case "Start": case "Load": case "Init":
				if(text == "Load") nchain = 1;
	...
	case PDFBUT:
		new_win = nw.Window.open('BICI Manual_v1.0.pdf'); 
		break;
	...
	case RELOADINDMODBUT: break;
		
	case VIDEOAC: mapvideo(); break;
	
	case MENUSLIDEBUT: case SLIDEBUT: break;
