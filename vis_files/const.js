...
var submax = 6;                  // The maximum number of submenus
var aspect_ratio = 2;            // Determins the shape of the display
var map_ratio = 1.22;            // Gives the aspect ratio for the maps
var tabledy = 28;                // The height of lines for tables
var textsize = 25;               // The font size used for the compartmental model
var seltabledy = 22;             // The height of lines for select param table
var sellinemax = 6;              // The maximum of lines for seltable

// Canvas buttons
var RESULTBUT = 0, RESULTBUT2 = 1, RESULTBUT3 = 2, RESULTBUT4 = 3;
var XLABELBUT = 4, YLABELBUT = 5;
